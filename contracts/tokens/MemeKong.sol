...
contract MEMEKONG is Context, IERC20, Ownable {
    using SafeMath for uint256;

    string private constant _name = "MEME KONG"; //
    string private constant _symbol = "MKONG"; //
    ...
    address payable private _developmentAddress =
        payable(0x56B60b78899d36d5Ad14e4fc2c842C76E51b9782); //
    address payable private _marketingAddress =
        payable(0xb118f3dfF544Caa46CB3965280ad710DB7b52B09); //
