...
contract SCIDAO is ERC20, Ownable {
    ...
    IERC20 public constant USDC =
        IERC20(0xeb8f08a975Ab53E34D8a0330E0D34de942C95926); // Testnet: 0xeb8f08a975Ab53E34D8a0330E0D34de942C95926  //Mainnet: 0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48
    ...
    function swapBack() private {
        ...
        uint256 usdcForOperations = (usdcBalance * tokensForOperations) /
            (totalTokensToSwap - (tokensForLiquidity / 2));
        uint256 usdcForYasha = (usdcBalance * tokensForYasha) /
            (totalTokensToSwap - (tokensForLiquidity / 2));
    ...
    function setYashaAddress(address _yashaAddress) external onlyOwner {
        require(
            _yashaAddress != address(0),
            "_yashaAddress address cannot be 0"
        );
    ...
    function withdrawRequestedLP() external onlyOwner {
        ...
        uint256 amtToWithdraw = (IERC20(address(lpPair)).balanceOf(
            address(this)
